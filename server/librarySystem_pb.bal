...
public client class LibraryListAllBooksCaller {
    ...
    isolated remote function sendListAllBooks(ListAllBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextListAllBooks(ContextListAllBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class LibraryListAllAvailableBooksCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendListAllAvailableBooks(ListAllAvailableBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextListAllAvailableBooks(ContextListAllAvailableBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class LibraryListAllBorrowedBooksCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendListAllBorrowedBooks(ListAllBorrowedBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextListAllBorrowedBooks(ContextListAllBorrowedBooks response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class LibraryLocateBookCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendLocateBook(LocateBook response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextLocateBook(ContextLocateBook response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class LibraryShowMessageCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendShowMessage(ShowMessage response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextShowMessage(ContextShowMessage response) returns grpc:Error? {
        return self.caller->send(response);
    }
